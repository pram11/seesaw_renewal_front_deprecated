...
const UserFormInput = ({id,label,type,value,onChange,required}:inputItem) => {
    ...
    console.log("UserFormInput id:",id,"value:",value)
...
const CreateUserForm = ({title,description,onSubmit,onChange,formItems,buttonText}:formProps) => {
    const phoneNumValidator = (value:string) => {
        const regExp = /^\d{3}-\d{3,4}-\d{4}$/;
        return regExp.test(value);
    }
    
    console.log("CreateUserForm props:",formItems)
    return (
        <div>
